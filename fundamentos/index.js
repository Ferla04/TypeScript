...
let estadoUsuarioNuevo = "activado";
//ejemplo template de strings `` se llaman backticks
let nombreUsuario = "Pepe Perez";
let ciudad = "Armenia";
let mensaje = `Bienvenido(a) ${nombreUsuario} a la ciudad de ${ciudad}`;
...
let arregloCualquiera = ["veinte", 20, true];
...
let meses = { enero: "Enero", febrero: "Febrero" };
