...
function tiposParametros(nombre:string, estado?:boolean, peso:number=100) {
...
let variableFuncion = function(habilitado:boolean) {
...
let saludoViajero = (nombre:string) => nombre;
...
let flechaVariasInstrucciones = (edad:number, peso:number) => {
